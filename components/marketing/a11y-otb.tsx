...
import {DemoCodeModal} from '../index'; // Adjust path as necessary

// const DemoCodeModal = dynamic(
//   () => import('../demo-code-modal').then((mod) => mod.DemoCodeModal),
//   {
//     ssr: false,
//   }
// );
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          ...
          >
            ...
            <Button
              ...
              variant="flat"
              onPress={() =>
                setIsDropdownOpen((prevOpenState) => !prevOpenState)
              }
            >
